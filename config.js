...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_1235834bc0737a4a6ea45452daf132bd9c').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '亗𝑴𝒖𝒛𝒂𝒏༒ 𝑺𝒖𝒌𝒖𝒏𝒂✰✭—͟͟͞͞𖣘',
  ...
  AUTO_STATUS_VIEW: (process.env.AUTO_STATUS_VIEW || 'yes').trim(),
  ...
  ANTI_DELETE: (process.env.ANTI_DELETE || 'yes').trim(),
